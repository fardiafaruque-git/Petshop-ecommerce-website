...
if(empty($err))
{
    ...
    if(mysqli_stmt_execute($stmt)){
        ...
        if(mysqli_stmt_num_rows($stmt) == 1)
            ...
            {
                // Wrong email entered
                echo '<script>alert("Wrong email or password. Please try again.");window.location = "adminLogin.php";</script>';
            }
...
<body>
  <div class="container">
    ...
    <div class="form">
        ...
        <a href="adminReg.php" class="link">don't have an account? Register one</a>
    </div>
