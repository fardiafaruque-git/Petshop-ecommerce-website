<?php
	...
	if (isset($_POST['post_comment'])) {
		...
		$sql = "INSERT INTO fancyfeastgrilledchicken (name, message)
		VALUES ('$name', '$message')";
...
<div style="padding-top:140px;">
    <h1 >Fancy Feast Grilled Chicken</h1>
    <br>
    <pre>             <img src="images/mini/f10.jpg" alt=""></pre>
</div>
	<section class="section1">
      ...
      <input type="text" class="name" name="name" placeholder="Name" value="<?php echo "" . $_SESSION['username'] ?>" readonly>
		...
		<div class="content">
            ...
            $sql = "SELECT * FROM fancyfeastgrilledchicken";
