...
$sql = "SELECT * FROM tblcard WHERE Type='dogadopt'";
...
<head>
    ...
    <link rel="stylesheet" href="css/dogAdopt.css">
...
<div class="navbar">		
    ...
    <section class="section1">
        ...
        <div class="aboutBox">
            <h1>Dogs & Puppies</h1>
            <h4>We are dedicated to finding loving homes for dogs in need. You will find a wide variety of dogs &
                puppies.
                We have a successful history of rescuing and rehoming animals, and our mission is to provide a second
                chance for these incredible creatures. Our adoption fees directly contribute to the care and welfare of
                the animals in our program.
                They are provided with proper care,
                including vaccinations and regular health check-ups, to ensure their well-being.
                By choosing to adopt, you not only change the life of a deserving animal but also support our ongoing
                rescue efforts. Together,
                we can make a difference and ensure that every dog finds a loving home. </h4>
        </div>
        <div class="aboutBox">
            <img src="img/dogAdopt.jpg" alt="">
        </div>
    </section>

    <section class="section2">
        <div class="text2">
            <h1>Available Dog & Puppies</h1>
        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="details">
                            <div class="center">
                                ...
                                <p>Age: 1 Year to 2 Year<br>Size:
                                    Regular<br>Vaccinated,Neutered<br>Adoption Fee: <?php echo $row["Price"]; ?> Tk</p>
